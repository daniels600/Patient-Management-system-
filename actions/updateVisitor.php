                                ...
                                ?>
                                  <!-- Using parsley js to validate the form inputs and regex -->
                                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" id='visitor_info' data-parsley-validate>
                                        ...
                                        <div class="form-group">
                                            <label for="patientname">Visited Patient's Name</label>
                                            <input class="form-control py-4" name="patient_name" type="text" placeholder="Enter Prisoner name" data-parsley-required="true" data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-trigger="keyup" data-parsley-error-message="Please enter a valid Prisoner name" value="<?php echo $visitorData['patient_name']; ?>" />
                                        </div>
