                                        ...
                                        <div class="form-group">
                                            <div >
                                                ...
                                                <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" id="dept_id" name='dept_name' data-parsley-trigger="keyup" required>
                                                    ...
                                                    <option value="Inpatient Service" <?= ($employeeData['Dept_name'] == 'Inpatient Service')? "selected" : "" ?> >Inpatient Service (IP)</option>
                                                    <option value="Outpatient" <?= ($employeeData['Dept_name'] == 'Outpatient')? "selected" : "" ?> >Outpatient department (OPD)</option>
                                                    <option value="Medical" <?= ($employeeData['Dept_name'] == 'Medical')? "selected" : "" ?> >Medical Department</option>
                                                    <option value="Nursing" <?= ($employeeData['Dept_name'] == 'Nursing')? "selected" : "" ?> >Nursing Department</option>
                                                    <option value="Radiology" <?= ($employeeData['Dept_name'] == 'Radiology')? "selected" : "" ?> >Radiology Department (X-ray)</option>
                                                    <option value="Pharmacy" <?= ($employeeData['Dept_name'] == 'Pharmacy')? "selected" : "" ?> >Pharmacy Department</option>
                                                    <option value="Dietary" <?= ($employeeData['Dept_name'] == 'Dietary')? "selected" : "" ?> >Dietary Department</option>
