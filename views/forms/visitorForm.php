                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action='../../actions/insertVisitor.php' method="POST" id='visitor_info' data-parsley-validate>
                                        ...
                                        <div class="form-group">
                                            <label class="small mb-1" for="patientname">Visited Patient's Name</label>
                                            <input class="form-control py-4" name="patient_name" type="text" placeholder="Enter Prisoner name" data-parsley-required="true" data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-trigger="keyup" data-parsley-error-message="Please enter a valid Prisoner name" />
                                        </div>
