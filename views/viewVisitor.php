                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                ?>
                                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" id='visitor_info' data-parsley-validate>
                                        ...
                                        <div class="form-group">
                                            <label class="small mb-1" for="patientrname">Visited Inmate Name</label>
                                            <input class="form-control py-2" name="patient_name" type="text" placeholder="Enter Patient name" data-parsley-required="true" data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-trigger="keyup" data-parsley-error-message="Please enter a valid Prisoner name" value="<?php echo $visitorData['patient_name']; ?>" readonly/>
                                        </div>
                                    </form>
                                </div>
                            </div>
