...
<body class="bg-primary" style="background-image: url('../assets/images/bg-image.jpg');height: 100%;  background-position: center;background-repeat: no-repeat;background-size: cover;">
    <div id="layoutAuthentication">
        <div id="layoutAuthentication_content">
            <main>
                <a class="btn btn-primary" href="../index.php" role="button" style="margin-left: 5%; margin-top: 5%;">Back</a>
                <div class="container">
