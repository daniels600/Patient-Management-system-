...
//A query to get all Patients
// $countPC= "SELECT * FROM patients";
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <img src="./assets/images/Medico_PMS_logo.png" width="30" height="40" class="d-inline-block align-top" alt="" style='margin-left:1%'>
                    ...
                    <div class="nav">
                        ...
                        <div >
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                <a class="nav-link" href="./views/patient.php">Patient</a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><br/>
                    ...
                    <div class="Message">
                        <h3 style='text-align:center'><u>Patient Management System (Medico_PMS)</u></h3>
                        <p style='text-align: justify;'>
                        <b>Medico_PMS</b> is an institute management system for the Patient Management. The main idea of this system is to create a central database system where all administrations of the various hospitals can know everything.
                        </p>
                    </div>
